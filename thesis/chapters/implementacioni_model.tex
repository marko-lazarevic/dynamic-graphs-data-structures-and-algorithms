...
\begin{itemize}
    ...
    \item \textit{Хеш индексирани блокови суседства} (енгл. \textit{Dynamic Hashed Blocks (DHB)}) - блоковска структура са хеш индексом који омогућава брз приступ суседима. Представља компромис између ефикасности ажурирања и сложености имплементације \cite{vandergrinten_et_al:LIPIcs.SEA.2022.11}.
\end{itemize}
